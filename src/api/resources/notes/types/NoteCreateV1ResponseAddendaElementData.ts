...
export interface NoteCreateV1ResponseAddendaElementData {
    PATIENT_NAME?: string;
    ICD10?: BridgeApi.NoteCreateV1ResponseAddendaElementDataFieldIcd10[];
    /** Array of medication names (e.g., ['Metformin 500mg', 'Lisinopril 10mg']) */
    MEDICATIONS?: BridgeApi.NoteCreateV1ResponseAddendaElementDataFieldMedication[];
    /** Array of allergies (e.g., ['Penicillin', 'Peanuts']) */
    ALLERGIES?: BridgeApi.NoteCreateV1ResponseAddendaElementDataFieldAllergy[];
    SUBJECTIVE?: string;
    OBJECTIVE?: string;
    ASSESSMENT?: string;
    TEXT?: string;
    ...
    MONITORING_DATA?: BridgeApi.NoteCreateV1ResponseAddendaElementDataFieldMonitoringDatum[];
    SCORED_ASSESSMENTS?: BridgeApi.NoteCreateV1ResponseAddendaElementDataFieldScoredAssessment[];
