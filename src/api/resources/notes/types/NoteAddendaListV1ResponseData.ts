...
export interface NoteAddendaListV1ResponseData {
    PATIENT_NAME?: string;
    ICD10?: BridgeApi.NoteAddendaListV1ResponseDataFieldIcd10[];
    SUBJECTIVE?: string;
    OBJECTIVE?: string;
    ASSESSMENT?: string;
    TEXT?: string;
    ...
    MONITORING_DATA?: BridgeApi.NoteAddendaListV1ResponseDataFieldMonitoringDatum[];
}
