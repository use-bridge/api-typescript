...
export class V2 {
     ...
     *
     * @param {BridgeApi.policies.PolicyCreateV2Request} request
     ...
     */
    public createPolicy(
        request: BridgeApi.policies.PolicyCreateV2Request,
        requestOptions?: V2.RequestOptions,
    ): core.HttpResponsePromise<BridgeApi.policies.PolicyCreateV2Response> {
    ...
    private async __createPolicy(
        request: BridgeApi.policies.PolicyCreateV2Request,
        requestOptions?: V2.RequestOptions,
    ): Promise<core.WithRawResponse<BridgeApi.policies.PolicyCreateV2Response>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as BridgeApi.policies.PolicyCreateV2Response,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BridgeApiTimeoutError("Timeout exceeded when calling POST /api/policies/v2.");
            case "unknown":
                throw new errors.BridgeApiError({
