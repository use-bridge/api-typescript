...
export interface ServiceEligibilityStreamV1ResponsePatientResponsibility {
    ...
    deductible: number;
    deductibleType?: BridgeApi.ServiceEligibilityStreamV1ResponsePatientResponsibilityFieldDeductibleType;
