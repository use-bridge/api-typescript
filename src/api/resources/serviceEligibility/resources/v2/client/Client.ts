...
export class V2 {
     ...
     *
     * @param {BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Request} request
    ...
    public createServiceEligibility(
        request: BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Request,
        requestOptions?: V2.RequestOptions,
    ): core.HttpResponsePromise<BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Response> {
    ...
    private async __createServiceEligibility(
        request: BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Request,
        requestOptions?: V2.RequestOptions,
    ): Promise<core.WithRawResponse<BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Response>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as BridgeApi.serviceEligibility.ServiceEligibilityCreateV2Response,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BridgeApiTimeoutError(
                    "Timeout exceeded when calling POST /api/service-eligibility/v2.",
                );
            case "unknown":
                throw new errors.BridgeApiError({
