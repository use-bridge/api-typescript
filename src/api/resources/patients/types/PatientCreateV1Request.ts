...
export interface PatientCreateV1Request {
    externalId?: string;
    firstName: string;
    lastName: string;
    email: string;
    dateOfBirth: string;
    phone?: string;
    address?: BridgeApi.PatientCreateV1RequestAddress;
    ...
    coverage?: BridgeApi.PatientCreateV1RequestCoverage[];
    /** Customizable object of string to string key-value data */
    metadata?: BridgeApi.PatientCreateV1RequestMetadata;
}
