...
export interface ServicesListV1ResponseItemServiceEligibilityFieldPatientResponsibility {
    ...
    deductible: number;
    deductibleType?: BridgeApi.ServicesListV1ResponseItemServiceEligibilityFieldPatientResponsibilityFieldDeductibleType;
