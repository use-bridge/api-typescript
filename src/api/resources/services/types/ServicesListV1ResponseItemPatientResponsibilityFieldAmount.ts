...
export interface ServicesListV1ResponseItemPatientResponsibilityFieldAmount {
    ...
    deductible: number;
    deductibleType?: BridgeApi.ServicesListV1ResponseItemPatientResponsibilityFieldAmountFieldDeductibleType;
