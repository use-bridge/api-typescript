...
export interface ServiceUpdateV2ResponseServiceEligibilityFieldPatientResponsibility {
    ...
    deductible: number;
    deductibleType?: BridgeApi.services.ServiceUpdateV2ResponseServiceEligibilityFieldPatientResponsibilityFieldDeductibleType;
