...
export interface ServiceUpdateV2ResponsePatientResponsibilityFieldAmount {
    ...
    deductible: number;
    deductibleType?: BridgeApi.services.ServiceUpdateV2ResponsePatientResponsibilityFieldAmountFieldDeductibleType;
