...
describe("V2", () => {
    ...
    test("cancelService", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/services/v2/id/cancel")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.services.v2.cancelService("id", {});
        expect(response).toEqual({
            id: "id",
            organizationId: "organizationId",
            status: "PENDING",
    ...
    test("updateService", async () => {
        ...
        const response = await client.services.v2.updateService("id", {});
        expect(response).toEqual({
            id: "id",
            organizationId: "organizationId",
            status: "PENDING",
