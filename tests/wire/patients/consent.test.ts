...
describe("Consent", () => {
    test("listPatient Consents", async () => {
        ...
        const response = await client.patients.consent.listPatientConsents("id");
    ...
    test("createPatient Consent", async () => {
        const server = mockServerPool.createServer();
        const client = new BridgeApiClient({ apiKey: "test", environment: server.baseUrl });
        ...
        const response = await client.patients.consent.createPatientConsent("id", {
            type: "ASSIGNMENT_OF_BENEFITS",
            version: "version",
            consentedAt: "2024-01-15T09:30:00Z",
        });
